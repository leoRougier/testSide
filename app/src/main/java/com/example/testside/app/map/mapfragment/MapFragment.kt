...
class MapFragment:BaseFragment<MapFragmentPresenter>(), MapFragmentView {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val mapFragment =
            childFragmentManager.findFragmentById(R.id.frg_map_container) as SupportMapFragment?  //use SuppoprtMapFragment for using in fragment instead of activity  TestFragment = activity   SupportMapFragment = fragment
          ...
          /*  mMap.mapType = GoogleMap.MAP_TYPE_NORMAL
            ...
            /*mMap.addMarker(
                MarkerOptions()
                    ...
                    .title("Spider Man")
                    .icon(context?.let { bitmapDescriptorFromVector(it, R.drawable.spider) })
            )
